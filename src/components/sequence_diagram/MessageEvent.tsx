...
export default function MessageEvent({ createdEvent, parsedEvent, xScale, yScale, startTime, isBlock, id, handleHover }: MessageEventProps) {
    ...
    const content = isBlock && !isQuicEvent ?
        <EncompassingBlock createdEvent={createdEvent} parsedEvent={parsedEvent} x1={createdX} y1={createdY} x2={parsedX} y2={parsedY} colors={colors} id={id} handleHover={handleHover} />
        :
